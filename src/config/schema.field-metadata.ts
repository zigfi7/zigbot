...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.zigmem.baseUrl": "ZigMem Base URL",
  "memory.zigmem.apiKey": "ZigMem API Key",
  "memory.zigmem.headers": "ZigMem Headers",
  "memory.zigmem.timeoutMs": "ZigMem Timeout (ms)",
  "memory.zigmem.mode": "ZigMem Search Mode",
  "memory.zigmem.maxResults": "ZigMem Max Results",
  "memory.zigmem.pathPrefix": "ZigMem Path Prefix",
...
export const FIELD_HELP: Record<string, string> = {
  ...
  "memory.backend":
    'Memory backend ("builtin" for OpenClaw embeddings, "qmd" for QMD sidecar, "zigmem" for external ZigMem API).',
  ...
  "memory.zigmem.baseUrl": "Base URL for ZigMem API (default: http://127.0.0.1:8000).",
  "memory.zigmem.apiKey": "Optional ZigMem bearer token (sent as Authorization: Bearer <token>).",
  "memory.zigmem.headers": "Optional extra headers merged into ZigMem requests.",
  "memory.zigmem.timeoutMs": "HTTP timeout for ZigMem requests in milliseconds (default: 8000).",
  "memory.zigmem.mode":
    'Default search mode used for ZigMem memory_search requests ("lexical", "semantic", "hybrid").',
  "memory.zigmem.maxResults": "Default maximum ZigMem results returned per search (default: 6).",
  "memory.zigmem.pathPrefix":
    "Prefix used in memory_search paths so memory_get can read ZigMem records (default: zigmem).",
  ...
  "agents.defaults.model.randomPool":
    'Optional random model pool used when model is set to "random". If empty, falls back to model.fallbacks, then agents.defaults.models keys.',
